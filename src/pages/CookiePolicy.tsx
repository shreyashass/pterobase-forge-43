...
export const CookiePolicy = () => {
    ...
    const fetchContent = async () => {
      try {
        ...
        setContent({
          id: 'fallback',
          title: 'Cookie Policy',
          content: 'Our cookie policy is currently being updated. Please contact support for more information.',
          meta_title: 'Cookie Policy - Pterodactyl Billing Panel',
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": content?.meta_title || "Cookie Policy",
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        title={content?.meta_title || "Cookie Policy - Pterodactyl Billing Panel"}
        description={content?.meta_description || "Learn about how we use cookies on our website."}
