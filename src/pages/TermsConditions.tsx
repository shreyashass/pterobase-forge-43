...
export const TermsConditions = () => {
    ...
    const fetchContent = async () => {
      try {
        ...
        setContent({
          ...
          content: 'Our terms and conditions are currently being updated. Please contact support for more information.',
          meta_title: 'Terms & Conditions - Pterodactyl Billing Panel',
          meta_description: 'Review the terms and conditions for using our services.',
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": content?.meta_title || "Terms & Conditions",
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        title={content?.meta_title || "Terms & Conditions - Pterodactyl Billing Panel"}
        description={content?.meta_description || "Review the terms and conditions for using our services."}
